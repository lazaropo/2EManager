...
template void
pf2e_manager::CommandBase::serialize<boost::archive::text_oarchive>(
    boost::archive::text_oarchive& ar, const unsigned int version);
template void
pf2e_manager::CommandBase::serialize<boost::archive::text_iarchive>(
...
template void
pf2e_manager::CommandBase::serialize<boost::archive::xml_iarchive>(
