...
void pf2e_manager::SubjectBase::serialize(Archive& ar,
...
template void
pf2e_manager::SubjectBase::serialize<boost::archive::text_oarchive>(
    boost::archive::text_oarchive& ar, const unsigned int version);
template void
pf2e_manager::SubjectBase::serialize<boost::archive::text_iarchive>(
...
template void
pf2e_manager::SubjectBase::serialize<boost::archive::xml_oarchive>(
    boost::archive::xml_oarchive& ar, const unsigned int version);
template void
pf2e_manager::SubjectBase::serialize<boost::archive::xml_iarchive>(
