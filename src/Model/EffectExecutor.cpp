...
void pf2e_manager::EffectExecutor::serialize(Archive& ar,
                                             const unsigned int version) {
  ar & _mediator;
}

template void
pf2e_manager::EffectExecutor::serialize<boost::archive::text_oarchive>(
    boost::archive::text_oarchive& ar, const unsigned int version);
template void
pf2e_manager::EffectExecutor::serialize<boost::archive::text_iarchive>(
...
template void
pf2e_manager::EffectExecutor::serialize<boost::archive::xml_oarchive>(
    boost::archive::xml_oarchive& ar, const unsigned int version);
template void
pf2e_manager::EffectExecutor::serialize<boost::archive::xml_iarchive>(
